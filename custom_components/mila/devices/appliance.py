...
#from ..entities.appliance.const import PRESET_MODE_AUTOMAGIC
...
class MilaAppliance(MilaDevice):
    ...
    def _get_all_entities(self) -> List[Entity]:
        ...
        entities = [
            ...
            MilaApplianceMeasurementSensor(self, "Air Changes", ApplianceSensorKind.Ach, uom = "cph", icon="mdi:cloud-refresh"),
            ...
            MilaApplianceMeasurementSensor(self, "Fan Speed", ApplianceSensorKind.FanSpeed, uom = "rpm", icon="mdi:fan"),
            MilaApplianceMeasurementSensor(self, "Humidity", ApplianceSensorKind.Humidity, device_class=SensorDeviceClass.HUMIDITY, uom=PERCENTAGE),
            ...
            MilaApplianceMeasurementSensor(self, "VOC", ApplianceSensorKind.Voc, device_class=SensorDeviceClass.VOLATILE_ORGANIC_COMPOUNDS, uom=CONCENTRATION_PARTS_PER_BILLION),
            MilaApplianceMeasurementSensor(self, "Temperature", ApplianceSensorKind.Temperature, uom=TEMP_CELSIUS, device_class=SensorDeviceClass.TEMPERATURE),
